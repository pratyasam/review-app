...
<div class="container-fluid">
    <div class="row">
        <div class="panel panel-default login-form-wrapper card col-lg-4 col-lg-offset-4 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12">
            <div class="social-wrapper card col-lg-10 col-lg-offset-1 bg-primary">
                <div class="social-icons col-lg-6 col-lg-offset-3">
                    <div class="icon-container col-lg-6 col-md-6 col-sm-6 col-xs-6"><span
                            class="fa fa-facebook-official"></span></div>
                    <div class="icon-container col-lg-6 col-md-6 col-sm-6 col-xs-6"><span
                            class="fa fa-google-plus-official"></span></div>
                </div>
            </div>
                    ...
                    <form:form name="signupFrom" id="signupForm" cssClass="form-horizontal" method="post"
                        ...
                        <fieldset class="pad-tb-20">
                                ...
                                <div class="col-lg-12">
                                    <div class="input-group"> <span class="input-group-addon">
                                        ...
                                        <form:input path="lastName" type="text" cssClass="form-control"
                                                    id="inputLatName" placeholder="Last Name" required="required"/>
                                    </div>
                                </div>
                            </div>
                            <br>
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <div class="input-group"> <span class="input-group-addon">
                                                <span class="fa fa-user-plus fa-2x"></span> </span>
                                        <form:input path="userName" type="text" cssClass="form-control"
                                                    id="inputUsername" placeholder="Username" required="required"/>
                                    </div>
                                </div>
                            </div>
                            <br>
                            <div class="form-group">
                                <div class="col-lg-12">
                                    <div class="input-group"> <span class="input-group-addon">
                                                <span class="fa fa-key fa-2x"></span> </span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <div class="radio">
                                        <label>
                                            <form:radiobutton path="gender" name="optionsRadios" id="optionsRadios1"
                                                              value="Female" required="required"/> Female </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <form:radiobutton path="gender" name="optionsRadios" id="optionsRadios1"
                                                              value="Male" required="required"/> Male </label>
                                    </div>
                                    <div class="radio">
                                        <label>
                                            <form:radiobutton path="gender" name="optionsRadios" id="optionsRadios2"
                                                              value="Others" required="required"/> Others </label>
                                    </div>
                                </div>
                            </div>
                            <br>
