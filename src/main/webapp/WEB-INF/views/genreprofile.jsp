			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><img src="/reviewBook/assets/img/book.jpg"
						...
						style="height: 60px; width: 60px;">Hello <%=(String) session.getAttribute("userName")%>></li>
							...
							<div class="col-lg-6">
								<div class="row">
									...
									<div class="col-lg-8">
										...
										<div data-rateyo1="rateYo" class="text-center" data-rating="<%= a.getAuthorRating() %>" style="margin-left: 55px;"></div> <br>
												<div class="sidebar-box">
