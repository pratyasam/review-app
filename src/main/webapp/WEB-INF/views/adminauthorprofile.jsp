...
<link href="/reviewBook/assets/css/adminauthorprofile-style.css" rel="stylesheet">
...
<body>
	...
	<div class="container-fluid">
		<div class="col-lg-6 col-lg-offset-3">
			<div class="col-lg-3">
				<div class="row">
					<div class="col-lg-12" style="height: 20%">
						<img src="/reviewBook/uploads/${author.authorImage}"
					...
					<div class="nav">
						<div class="col-lg-12 col-md-12 col-xs-12">
							...
							<div class="col-lg-4 col-md-4 col-xs-12 well">
								<a href="/reviewBook/authors/${author.authorId}/authorupload "> <i
								...
								<div class="col-lg-6 col-md-6">
									...
									<div class="col-lg-10 col-lg-offset-2">
										...
										<a class="btn btn-primary"
											href="/reviewBook/authors/${author.authorId}/update">Update</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-12">
						...
						<div
							...
							<ul class="pagination">
								...
								%>
								<li><a
									href="/reviewBook/authors/${author.authorId}?pagenob=<%= i%>&pagenou=1&pagenor=1"><%=i%></a></li>
								<%
									}
								%>
							</ul>
			...
			<div class="col-lg-12">
				<div class="jumbotron text-center">
					...
					<ul class="pagination">
						...
						%>
						<li><a
							href="/reviewBook/authors/${author.authorId}?pagenor=<%= i%>&pagenob=1&pagenou=1"><%=i%></a></li>
						<%
							}
						%>
					</ul>
			...
			<br>
			<div class="col-lg-12">
				<form:form method="post" action="${author.authorId}"
					class="form-horizontal" modelAttribute="authorprofile">
					<fieldset>
						<div class="col-lg-12">
							<div class="form-group">
								<div class="well-primary well-sm ">
									<h6 class="text-right">
										Please <a href="login">Log-In</a> to Review.
									</h6>
								</div>
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<form:form method="delete"
						action="/reviewBook/authors/${author.authorId}"
						modelAttribute="delete">
						<fieldset>
							<div class="form-group">
								<div class="col-lg-10 col-lg-offset-2">
