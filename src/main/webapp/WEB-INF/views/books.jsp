...
<link rel="stylesheet" type="text/css" href="/reviewBook/assets/css/books-style.css">
...
<body>
					...
					<fieldset>
						<div class="col-lg-6 col-lg-offset-3">
							<div class="form-group">
								<input name="searchParam" type="text" class="form-control" id="search"
	...
	<div class="container-fluid">
		<div id="mySidenav" class="sidenav col-lg-3 col-md-3 hidden-xs">
		...
		<div class="col-md-9 col-md-offset-3 col-xs-12">
			<div class="row"
				style="background-image: url(/reviewBook/assets/img/imageedit__7035736840.jpg); background-size: cover; height: 420px; margin-bottom: 24px;"></div>
				...
				<div class="col-xs-12">
					...
					<div
						...
						<ul class="pagination">
							...
							%>
							<li><a href="/reviewBook/books?pageno=<%=i%>"><%=i%></a></li>
							<%
								}
							%>
						</ul>
