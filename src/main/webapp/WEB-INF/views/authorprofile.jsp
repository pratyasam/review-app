...
<html lang="en">
<%
	AlreadyReviewedException e = (AlreadyReviewedException) request.getAttribute("alreadyReviewedException");
%>
...
<link href="/reviewBook/assets/css/authorprofile-style.css" rel="stylesheet">
				...
				<div class="jumbotron text-center">
					...
					<div class="media">
						<div class="media-left">
							<img src="/reviewBook/uploads/${userImage}" alt="avatar" class="media-object"
								style="width: 60px">
						</div>
