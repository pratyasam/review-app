				...
				<div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3">
					<div class="panel panel-primary">
						<div class="panel-body">
							...
							<b><p class="text-center" style="font-size: 120%;">Please
									enter your user name.</p></b>

							<form:form method="post" action="/reviewBook/verification"
										...
										<div class="col-lg-12">
											<div class="input-group">
												...
												<form:input type="text" path="choice"
													...
													rows="3" cols="10" maxlength="4005" autocomplete="off"></form:input>
											</div>
										</div>
									</div>
									<br>
