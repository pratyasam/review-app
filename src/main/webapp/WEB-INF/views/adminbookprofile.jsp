		...
		<div class="col-lg-6 col-lg-offset-3">
								...
								<div class="col-lg-4 col-md-4">
									<div class="col-lg-10 col-lg-offset-2">
										<button class="btn btn-primary " data-toggle="modal"
											data-target="#myModal1">Verify</button>
									</div>
								</div>
								<div class="col-lg-4 col-md-4">
									<div class="col-lg-10 col-lg-offset-2">
			...
			<div class="col-lg-12">
				<div class="jumbotron text-center">
					...
					%>
					<div class="row">
						<div class="col-lg-2 col-sm-2 col-md-2" style="height: 10%;">
						...
						<div class="col-lg-10 col-md-10 col-sm-12">
							<div class="well well-sm" style="margin-top: 10px;">
								<div class="row">
									<div class="head col-lg-6 col-md-6 col-sm-6">
										<h6><%=rb.getUser().getFirstName()%>
											reviewed :
										</h6>
									...
									<div class="edit col-lg-6 col-md-6 col-sm-6"
								...
								<div class="well-primary well-lg">
							...
							<div class="col-lg-12">
								<div class="form-group">
									<div class="well-primary well-sm ">
										<h6 class="text-right">
											Please <a href="/reviewBook/login">Log-In</a> to Review.
										</h6>
									</div>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<form:form method="delete"
							action="/reviewBook/authors/${book.bookId}"
							modelAttribute="delete">
							<fieldset>
								<div class="form-group">
									<div class="col-lg-10 col-lg-offset-2">
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<h4 class="modal-title">verify Book?</h4>
					</div>
					<div class="modal-footer">
						<form:form method="post" action="${book.bookId}/verifybooks"
							...
							<fieldset>
								<div class="form-group">
									<div class="col-lg-10 col-lg-offset-2">
										...
										<br>
										<form:button type="submit" class="btn btn-sm btn-danger "> Verify</form:button>
										<form:button type="button" class="btn btn-sm btn-primary "
											data-dismiss="modal"> Cancel</form:button>
									</div>
								</div>
