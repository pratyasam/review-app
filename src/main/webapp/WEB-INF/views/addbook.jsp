				...
				<div class="col-lg-6 col-lg-offset-3">
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<form:form method="post" id="book" action="addbook"
								cssClass="form-horizontal" name="book" modelAttribute="book">
										...
										<div class="col-lg-12">
											<div class="input-group">
												...
												<form:input path="bookRating" type="number"
													cssClass="rating rating-loading" data-min="0" data-max="5"
													data-step="0.1" data-size="lg"/>
											</div>
										</div>
									</div>
									<br>
